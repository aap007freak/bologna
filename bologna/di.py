...
def _inject_sync(f):
    global _injectables
    pos_only_parameters, pos_key_parameters, var_pos_key_parameters, key_only_parameters, var_key_parameters = analyze_signature(f)

    @functools.wraps(f)
    def wrapper(*args, **kwargs):

        key_only_arguments, pos_key_arguments, pos_only_arguments, var_key_arguments, var_pos_key_arguments = construct_arguments(
            pos_only_parameters, pos_key_parameters, var_pos_key_parameters, key_only_parameters, var_key_parameters, args, kwargs)
...
def analyze_signature(f):
    ...
    return pos_only_parameters, pos_key_parameters, var_pos_key_parameters, key_only_parameters, var_key_parameters

def construct_arguments(pos_only_parameters, pos_key_parameters, var_pos_key_parameters, key_only_parameters, var_key_parameters, args, kwargs):
        ...
        providable_positional_only_parameters = providable_parameters(
            pos_only_parameters
        )
        ...
        return key_only_arguments, pos_key_arguments, pos_only_arguments, var_key_arguments, var_pos_key_arguments
...
def _inject_async(f):
    ...
    async def wrapper(*args, **kwargs):
        key_only_arguments, pos_key_arguments, pos_only_arguments, var_key_arguments, var_pos_key_arguments = construct_arguments(
            pos_only_parameters, pos_key_parameters, var_pos_key_parameters, key_only_parameters, var_key_parameters,
            args, kwargs)
